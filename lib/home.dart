...
class _ScheduleTab extends State<ScheduleTab> {
  ...
  List<BottomNavigationBarItem> _btbItems = [
    ...
    new BottomNavigationBarItem(
        icon: Icon(Icons.schedule), title: Text('Agenda')),
...
//    getImages();
  ...
  getImages() async {
    var res = await http.get("https://www.instagram.com/pablo384/?_a=1");
    print(res.body);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      drawer: new Drawer(
          child: new ListView(
        children: <Widget>[
          Container(color: Colors.black26, child: Image.asset("images/logo.png")),
          new ListTile(
            subtitle: new Text(
              ""
          ...
          ListTile(
            title: new Text(
                'Para mas  información visitanos en nuestra pagina web o nuestro Facebook'),
            onTap: () {},
          ),
//                  InkWell(
          ...
          Row(
            ...
            children: <Widget>[
              ...
              IconButton(
                  ...
                  onPressed: () {
                    _launchURL(
                        "https://www.facebook.com/groups/GNULinuxDominicana/");
                  }),
              IconButton(
                  icon: Icon(FontAwesomeIcons.globe),
                  onPressed: () {
                    _launchURL("https://opensaturday.org");
                  }),
            ],
          ),
          Padding(
            ...
            child: RaisedButton(
              ...
              onPressed: () {
                Share.share(
                    'Te comparto el link de la app del OpenSaturday: https://play.google.com/store/apps/details?id=org.mairelin.eventscheduleapp');
              },
            ),
          ),
        ],
